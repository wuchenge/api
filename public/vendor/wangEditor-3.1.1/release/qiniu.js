/*
 * @Author: wuchenge
 * @Date:   2018-11-09 11:51:10
 * @Last Modified by:   wuchenge
 * @Last Modified time: 2018-11-09 14:00:36
 */
...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        ...
        that.up_url = op.up_url || 'http://up.qiniu.com';
        that.token = '';
        ...
        uploader.bind('BeforeUpload', function(up, file) {
            ...
            if (uploader.runtime === 'html5' && chunk_size) {
                if (file.size < chunk_size) {
                    ...
                    up.setOption({
                        'url': that.up_url + 'mkblk/' + blockSize,
                        'multipart': false,
        ...
        uploader.bind('ChunkUploaded', function(up, file, info) {
            ...
            if (leftSize < chunk_size) {
                up.setOption({
                    'url': that.up_url + 'mkblk/' + leftSize
                });
            }
        ...
        uploader.bind('FileUploaded', (function(_FileUploaded_Handler) {
            return function(up, file, info) {
                ...
                if (ctx) {
                    ...
                    var url = that.up_url + 'mkblk/' + file.size + key + x_vars_url;
                    var ajax = that.createAjax();
